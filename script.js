...
const lineups = {
  dust2: {
    t: {
      smoke: [
        ...
        },
        {
          ...
          name: "B Retake Smoke",
          position: "Jump + Left Click Throw",
          video: "https://www.youtube.com/embed/zbHcJuR9Xrg?si=MiCUkC9RrOlktp9h",
          thumbnail: "https://img.youtube.com/vi/zbHcJuR9Xrg/maxresdefault.jpg",
          side: "t",
          difficulty: "Easy",
          description: "T Spawn",
        },
        {
          id: 6,
          name: "CT A Long Smoke",
          position: "Jump + Left Click Throw",
          video: "https://www.youtube.com/embed/J3_DgVGo3tQ?si=xODvrkJ5eknG_5QG",
          thumbnail: "https://img.youtube.com/vi/J3_DgVGo3tQ/maxresdefault.jpg",
          side: "t",
          difficulty: "Easy",
          description: "T Spawn",
        },
        {
          ...
          video: "https://www.youtube.com/embed/Dm2i9H0CGXE?si=Jyet_E67SbNYa0Ug",
          thumbnail: "https://img.youtube.com/vi/Dm2i9H0CGXE/maxresdefault.jpg",
          side: "t",
          difficulty: "Easy",
          description: "T Spawn",
        },
        {
          id: 8,
          name: "CT Spawn Smoke No Gap",
          position: "Crouch + Left Click + Jumpthrow",
          video: "https://www.youtube.com/embed/0y8yIC6zAsY?si=8U2lCA5QYGQCeJ1T",
          thumbnail: "https://img.youtube.com/vi/0y8yIC6zAsY/maxresdefault.jpg",
          side: "t",
          difficulty: "Easy",
          description: "Mid",
        },
        {
          id: 9,
          name: "Mid Door Smoke",
          position: "Left Click + Jumpthrow",
          video: "https://www.youtube.com/embed/8yhLyS5kenY?si=0IcXIApg2L4jAcu3",
          thumbnail: "https://img.youtube.com/vi/8yhLyS5kenY/maxresdefault.jpg",
          side: "t",
          difficulty: "Hard",
          description: "T Spawn",
        },
      ...
      flash: [
        {
          ...
          position: "Right Click + Jumpthrow",
          video: "https://www.youtube.com/embed/nlpvsbNGryM?si=rDuEw3t3lQttxtVx",
          thumbnail: "https://img.youtube.com/vi/nlpvsbNGryM/maxresdefault.jpg",
          side: "T-Side",
          difficulty: "Medium",
          description: "CT A Long",
        }
      ],
      molotov: [
        {
          ...
          video: "https://www.youtube.com/embed/67wr8jkFhMk?si=c56lGJTXmOjciF8q",
          thumbnail: "https://img.youtube.com/vi/67wr8jkFhMk/maxresdefault.jpg",
          side: "T-Side",
          difficulty: "Easy",
          description: "Mid",
        }
    ...
    both: {
      ...
      {
        id: 2,
        name: "A Site And Short Pop Flash",
        position: "Left Click Throw",
        video: "https://www.youtube.com/embed/ycwZtaRCo_o?si=4qMo2Xql4xmfaUpz",
        thumbnail: "https://img.youtube.com/vi/ycwZtaRCo_o/maxresdefault.jpg",
        side: "Both Sides",
        difficulty: "Easy",
        description: "A Site",
      },
      {
        ...
        name: "A Site Pop Flash",
        position: "Left Click + Jumpthrow",
        video: "https://www.youtube.com/embed/pw78j44LKFc?si=DdLM8IiDo5y4Fh0m",
        thumbnail: "https://img.youtube.com/vi/pw78j44LKFc/maxresdefault.jpg",
        side: "Both Sides",
        difficulty: "Easy",
        description: "A Short",
      }
    ...
    ct: { smoke: [
      {
        id: 1,
        name: "Banana Smoke",
        position: "Left + Right Click Throw",
        video: "https://www.youtube.com/embed/Cz8hhMQrR1Y?si=IX4CTkDA46suPeOY",
        thumbnail: "https://img.youtube.com/vi/Cz8hhMQrR1Y/maxresdefault.jpg",
        description: "b Site",
        difficulty: "Easy",
        side: "CT-Side",
      }
    ], flash: [
      {
        ...
        position: "Left Click Throw",
        video: "https://www.youtube.com/embed/NehNnraqH_Q?si=RsoRkCownN6ZYVpp",
        thumbnail: "https://img.youtube.com/vi/NehNnraqH_Q/maxresdefault.jpg",
        description: "B site",
        difficulty: "Easy",
        side: "CT-Side",
      }
      ...
      {
        id: 1,
        name: "Banana Moly From B Site",
        position: "Left Click Throw",
        video: "https://www.youtube.com/embed/5A_d3u0_RyY?si=AyPAHjobmTLZQoiW",
        thumbnail: "https://img.youtube.com/vi/5A_d3u0_RyY/maxresdefault.jpg",
        description: "B site",
        difficulty: "Easy",
        side: "CT-Side",
      }
  ...
  anubis: {
    ...
    ct: { smoke: [], flash: [{
      id: 1,
      name: "Mid Pop Flash From A Con",
      position: "Right Click + Jumpthrow",
      video: "https://www.youtube.com/embed/wRizVxGzAaE?si=9MNkoqdsDZ_JU4ar",
      thumbnail: "https://img.youtube.com/vi/wRizVxGzAaE/maxresdefault.jpg",
      side: "CT-Side",
      difficulty: "Easy",
